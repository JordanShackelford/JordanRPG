    ...
    if (tileKey === 'portal') {
        ...
        drawPlayer: () => {
            ...
            function drawDustCloud() {
                const DUST_PARTICLE_COUNT = 20; // More particles
                const MIN_SIZE = 5; // Increased minimum size
                const MAX_SIZE = 20; // Increased maximum size
                const MIN_OPACITY = 0.5; // Minimum opacity increased
                const MAX_OPACITY = 0.9; // Maximum opacity increased
